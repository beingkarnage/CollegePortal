...
@WebServlet("/std_home")
public class std_home extends HttpServlet {
	...
	if(isLogin){
        ...
        try {
            ...
            ResultSet rs=stmt.executeQuery("select * from clg_ntf limit 50;");
		out.println("<html lang=\"en\"><head>\r\n" + 
				...
				"						</li>\r\n" + 
				"						<li class=\"nav-item\">\r\n" + 
				"							<a class=\"nav-link\" href=\"std_pro\">My Profile</a>\r\n" + 
				"						</li>\r\n" + 
				"						<li class=\"nav-item\">\r\n" + 
				"							<a class=\"nav-link\" href=\"active_ass\">All Assignments</a>\r\n" + 
				"						</li>\r\n" + 
				
"						<li class=\"nav-item\">\r\n" + 
"							<a class=\"nav-link\" href=\"academics\">View Academics</a>\r\n" + 
"						</li>\r\n" + 

										
										"<li class=\"nav-item\">\r\n" + 
				"							<a class=\"nav-link \" href=\"active_queue\">Active Queues</a>\r\n" + 
				"						</li>\r\n" + 
				"						<li class=\"nav-item\">\r\n" + 
				...
				"						<li class=\"nav-item\">\r\n" + 
				"							\r\n" + 
				"							<a class=\"nav-link \" href=\"user_ntf\">My Notifications(Student)</a>\r\n" + 
				"						</li>\r\n" +  
				"						<li class=\"nav-item\">\r\n" + 
						"							\r\n" + 
						"							<a class=\"nav-link \" href=\"user_ntf_clg\">My Notifications(College)</a>\r\n" + 
						"						</li>\r\n" +  
				"						\r\n" + 
				"					</ul>\r\n" + 
				"				</div>\r\n" + 
		...
		if(msg.contains("[")) {
			String sno= msg.substring(msg.indexOf("[")+1, msg.indexOf("]"));
				out.println("<div class=\"col-md-12\">\r\n" + 
				"					<div class=\"alert alert-dismissible alert-info\">\r\n" + 
				"  <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>\r\n" + 
				"  <h4 class=\"alert-heading\">Already Existed !!!</h4>\r\n" + 
				"  <p class=\"mb-0\">You are already exists in that queue at "+sno+" <a href=\"active_queue\" class=\"alert-link\">Please select another queue to book slot</a>.</p>\r\n" + 
				"</div>\r\n" + 
				"				</div>");sess.setAttribute("msg", "0");}
		else if(msg.contains("(")) {
			String sno = msg.substring(msg.indexOf("("), msg.indexOf(")"));
			System.out.println(sno);
			out.println("<div class=\"col-md-12\">\r\n" + 
			"					<div class=\"alert alert-dismissible alert-info\">\r\n" + 
			"  <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>\r\n" + 
			"  <h4 class=\"alert-heading\">Info !!!</h4>\r\n" + 
			"  <p class=\"mb-0\">Your slot has been booked at "+sno+"<a href=\"active_queue\" class=\"alert-link\">Please be notified about your slot</a>.</p>\r\n" + 
			"</div>\r\n" + 
			"				</div>");sess.setAttribute("msg", "0");
		...
		out.println("<div class=\"col-md-12\">\r\n" + 
			...
			"  <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>\r\n" + 
			"  <h4 class=\"alert-heading\">Info !!!</h4>\r\n" + 
			"  <p class=\"mb-0\">Queue limit reached to max try again later <a href=\"active_queue\" class=\"alert-link\">Please select another queue to book slot</a>.</p>\r\n" + 
			"</div>\r\n" + 
			"				</div>");sess.setAttribute("msg", "0");
		...
		if(msg.contains("!")) {
			...
			out.println("<div class=\"col-md-12\">\r\n" + 
					"					<div class=\"alert alert-dismissible alert-success\">\r\n" + 
					"  <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>\r\n" + 
					"  <h4 class=\"alert-heading\">Your Assignment has been uploaded successfully...</h4>\r\n" + 
					"  <p class=\"mb-0\"> Need to upload more <a href=\"active_ass\" class=\"alert-link\">click here  </a>.</p>\r\n" + 
					"</div>\r\n" + 
					"				</div>");sess.setAttribute("msg", "0");
			...
			out.println("<div class=\"col-md-12\">\r\n" + 
					...
					"  <p class=\"mb-0\"> Check Others <a href=\"active_ass\" class=\"alert-link\">here  </a>.</p>\r\n" + 
					"</div>\r\n" + 
					"				</div>");sess.setAttribute("msg", "0");
