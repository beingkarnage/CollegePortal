 ...
 */
@WebServlet("/user_ntfs")
public class user_ntfs extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
            ...
            ResultSet rs=stmt.executeQuery("select * from std_ntf where uid="+uid+";");
            out.println("\r\n" + 
            		"<html lang=\"en\"><head>\r\n" + 
            		"    <meta charset=\"utf-8\">\r\n" + 
            		...
            		"<td><form action=\"delete_ntf\"><input type=\"hidden\" name=\"ntf_id\" value="+uid+"><input type=\"hidden\" name=\"type\" value=\"std\">"  + 
