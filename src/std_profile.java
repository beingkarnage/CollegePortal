...
@WebServlet("/std_profile")
public class std_profile extends HttpServlet {
	...
	if(isLogin) {
	String name=(String)sess.getAttribute("std_name");
	String uid=(String)sess.getAttribute("uid");
	String rollno=(String)sess.getAttribute("roll_no");
	...
	out.println("\r\n" + 
		...
		out.println("Anauthorized access!!!");
	}
	}
