...
public class fac_add_academics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if(msg.contentEquals("A")) {
			out.println("<p class=\"text-success\">Student Added</p>");
			sess.setAttribute("msg","0");
		}else {
			out.println("<p class=\"text-warning\">No new student added yet</p>");
		}
		out.println(
				"								</th>\r\n" + 
				"								<th>\r\n" + 
				...
				"								<td>\r\n" + 
				"								<form action=\"_add_academics\">	Roll No \r\n" + 
				"								</td>\r\n" + 
				"								<td >\r\n" + 
...
"							\" style=\"border-radius:26px;\">Add</button></form>\r\n" + 
"							</td>\r\n" + 
"							</tr>\r\n" +
