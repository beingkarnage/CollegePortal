 ...
 */
public class admin_manage_clg_ntfs extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public admin_manage_clg_ntfs() {
        super();
    }
    ...
    ResultSet rs=stmt.executeQuery("select * from clg_ntf;");
	out.println( 
    		"<html lang=\"en\"><head>\r\n" + 
    		"    <meta charset=\"utf-8\">\r\n" + 
    		...
    		"		<div class=\"col-md-12\">\r\n" + 
    		"			\r\n" + 
    		"			<form action=\"manage_ntf\"><button class=\"btn btn-outline-primary\">Show Student Ntf </button></form>\r\n" + 
    		"				<div class=\"row\">\r\n" + 
    		"				<div class=\"col-md-12\">\r\n" + 
