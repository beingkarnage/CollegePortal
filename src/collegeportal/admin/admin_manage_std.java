 ...
 */
public class admin_manage_std extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public admin_manage_std() {
        super();
    }
    ...
    ResultSet rs=stmt.executeQuery("select * from std_cred;");
	out.println( 
    		"<html lang=\"en\"><head>\r\n" + 
    		"    <meta charset=\"utf-8\">\r\n" + 
    		...
    		"		<div class=\"col-md-12\">\r\n" + 
    		"			\r\n" + 
    		"			<form action=\"edit_std\"><input type=\"hidden\" name=\"mode\" value=\"add\"><button class=\"btn btn-outline-primary\">Add New Students</button></form>\r\n" + 
    		"				<div class=\"row\">\r\n" + 
    		"				<div class=\"col-md-12\">\r\n" + 
    		...
    		"								<th></th>\r\n" + 
    		"								<th><h4 style= \"position:relative;left:50%;\">All Students</h3></th><th></th><th></th><th></th>	\r\n" +
    		"								\r\n" + 
    		"									\r\n" + 
    		"								\r\n" + 
    		"							</tr>\r\n" + 
    		...
    		"								<td>"+roll_no+"</td>\r\n" +
    		"								<td>"+branch+"</td>\r\n" +
    		"								<td><form action=\"edit_std\"><input type=\"hidden\" name=\"uid\" value="+uid+"><input type=\"hidden\" name=\"mode\" value=\"edit\">" + 
    		"										<button class=\"btn btn-primary\" type=\"submit\" style=\"border-radius:26px;\">Edit</button> </form></td>\r\n" + 
    		"<td><form action=\"delete_std\"><input type=\"hidden\" name=\"uid\" value="+uid+">" + 
    		"										<button class=\"btn btn-danger\" type=\"submit\" style=\"border-radius:26px;\">Delete</button> </form></td>"+
    		"							</tr>\r\n" + 
    		"						\r\n" );}
    		out.println("<tr align=\"center\"><td colspan=\"7\">\r\n" + 
