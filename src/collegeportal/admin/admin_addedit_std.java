 ...
 */
public class admin_addedit_std extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public admin_addedit_std() {
        super();
    }
		...
		try {
		    ...
		    Statement stmt=con.createStatement();
				...
				if(mode.contentEquals("edit")) {
					ResultSet rs=stmt.executeQuery("select * from std_cred where uid="+uid+";");
			    		while(rs.next()) {
			    				...
			    				out.println(	
			    		"							<form action=\"_edit_std\"><tr class=\"table-dark\">\r\n" + 
			    		...
			    		"								<td><input type=\"text\" name=\"roll_no\" value="+roll_no+" placeholder="+roll_no+"></td>\r\n" +
			    		"								<td><input type=\"text\" name=\"branch\" value="+branch+" placeholder="+branch+"></td>" +
			    		" 								<input type=\"hidden\" value="+uid+" name=\"std_uid\">"+
			    		"							</tr>\r\n<tr align=\"center\"><td colspan=\"6\"><button class=\"btn btn-outline-info\" type=\"submit\">Edit</td></form>" +
			    		"						\r\n" );}
			    		}else if(mode.contentEquals("add")) {
			    			out.println(	
						    		"							<form action=\"_add_std\"><tr class=\"table-dark\">\r\n" + 
						    		"								<td><input type=\"text\" name=\"uid\" ></td>\r\n" + 
						       		"								<td><input type=\"text\" name=\"name\" </td>\r\n" + 
						    		"								<td><input type=\"text\" name=\"pass\" ></td>\r\n" + 
						    		"								<td><input type=\"text\" name=\"roll_no\" </td>\r\n" +
						    		"								<td><input type=\"text\" name=\"branch\" </td>" +
						    		"							</tr>\r\n<tr align=\"center\"><td colspan=\"6\"><button class=\"btn btn-outline-info\" type=\"submit\">Add</td></form>" +
						    		"						\r\n" );
			    		}
